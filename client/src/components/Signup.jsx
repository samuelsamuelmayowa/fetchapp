    ...
    <section className="min-h-screen bg-slate-950 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-xl rounded-3xl bg-white p-8 shadow-2xl">
        ...
        <button
          ...
          className="mb-6 flex items-center gap-2 bg-slate-100 px-4 py-2 rounded-xl"
        >
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          <button
            onClick={() => navigate("/signup/earner")}
            className="bg-blue-600 text-white p-4 rounded-2xl font-semibold"
          >
            Sign Up as Earner
          </button>
          ...
          <button
            ...
            className="bg-cyan-600 text-white p-4 rounded-2xl font-semibold"
          >
            Sign Up as Creator
          </button>
        </div>
        ...
        <a
          ...
          className="mt-8 flex justify-center text-blue-600 text-sm"
        >
